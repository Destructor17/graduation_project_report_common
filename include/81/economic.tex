...
\begin{table}[H]
    ...
    \begin{tabular}{|c|c|c|c|c|c|m{2cm}<{\centering}|m{2cm}<{\centering}|m{2cm}<{\centering}|}
        \hline
        \multirow{2}*{\rotatebox[origin=c]{90}{Категория работников\hspace{1.2cm}}} 
        ...
        & \multirow{2}*{\rotatebox[origin=c]{90}{$\textup{Ф}_\textup{эфф.р.в}$, (дн.)\hspace{1.9cm}}} 
        & \multirow{2}*{\rotatebox[origin=c]{90}{$\textup{Ф}_\textup{рф}$, (дн.)\hspace{2.25cm}}} 
        ...
        \hline
        Инженер-программист & \envGPRDevCategory & \envGPRDevCategoryMultiplier & \envGPRWorkingDaysInMonth & \envGPRDevTimeDays & \envGPRPremiumCoefficient & \envGPRValueZPosn & \envGPRValueZPdop & \envGPRValueZP \\
        \hline
